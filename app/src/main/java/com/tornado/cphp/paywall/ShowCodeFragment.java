...
public class ShowCodeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater,  ViewGroup container,  Bundle savedInstanceState) {
        return inflater.inflate(R.layout.fragment_show_code,container,false);
    }
    ...
    public void onActivityCreated( Bundle savedInstanceState) {
        ...
        txtQRCodeTitle.setText("Scan PayWall code to make payment to "+ VendorMainActivity.strVendorId);
