...
//                    String strWalletType= object.getString("wallettype");
                    ...
                    if (i==0){
                        ...
                        int preValues=Integer.parseInt(Balance.get(i-1));
                        if (strAmount.contains("-")){
                            int finalValues=preValues-Integer.parseInt(listLess.get(i));
                            Balance.add(String.valueOf(finalValues));
                        }else {
                            int totlaValues=preValues+Integer.parseInt(strAmount);
