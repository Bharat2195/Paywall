...
public class QRCodeResultActivity extends AppCompatActivity {
    ...
    private String strType,strMobileNumber;
...
//        etReason=(EditText)findViewById(R.id.etReason);
        ...
        if (strType.equalsIgnoreCase("qrcode")){
        ...
        btnProcessToPay.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (StringUtils.isBlank(strAmount) ) {
                ...
                }else if (Integer.parseInt(strAmount) > Integer.parseInt(VendorHomeAcivity.strSpitValue)){
                    ...
                    try{
                        ...
                        if (strType.equalsIgnoreCase("qrcode")){
                            ...
                            jsonObject.put("fromid", VendorHomeAcivity.strVendorId);
                            jsonObject.put("to",strQRCode);
                            jsonObject.put("amount",strAmount);
                        }else {

                            jsonObject.put("mode","vendorToOtherFundTransferWithMobileNumber");
                            jsonObject.put("fromid", VendorHomeAcivity.strVendorId);
