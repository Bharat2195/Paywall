...
import com.tornado.cphp.awhitepaid.memberpanel.MemberForgotPassword;
...
public class VendorForgotPasswordActivity extends AppCompatActivity {

    private static final String TAG=VendorForgotPasswordActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLogin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intentLogin=new Intent(VendorForgotPasswordActivity.this,MemberLoginActivity.class);
        ...
        btnOk.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (StringUtils.isBlank(strMobileNumber)){
                    Toast.makeText(VendorForgotPasswordActivity.this, "Please Enter Mobile Number", Toast.LENGTH_SHORT).show();
                }else {
    ...
    private class getPassword extends AsyncTask<String,String,String> {
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            pd=new ProgressDialog(VendorForgotPasswordActivity.this);
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (strStatus.equalsIgnoreCase("1")){
                    ...
                    Toast.makeText(VendorForgotPasswordActivity.this,Response , Toast.LENGTH_SHORT).show();
                }
