...
public class MemberMobileNumberToPay extends AppCompatActivity {
    private static final String TAG = MemberMobileNumberToPay.class.getSimpleName();
    private ImageView imgContact;
    private Toolbar mToolbarMemberMobilePay;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_member_mobile_number_to_pay);
        getSupportActionBar().hide();
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
            checkCameraPermission();
        }

        mToolbarMemberMobilePay = (Toolbar) findViewById(R.id.mToolbarMemberMobilePay);
        txtTitle = (TextView) mToolbarMemberMobilePay.findViewById(R.id.txtTitle);
        txtTitle.setText("Enter Mobile Number to Pay");
        mToolbarMemberMobilePay.setNavigationIcon(R.drawable.back_icon);
        mToolbarMemberMobilePay.setNavigationOnClickListener(new View.OnClickListener() {
            @Override
        ...
        btnTransfer.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (StringUtils.isBlank(strSpiltMobileNumber)) {
                    Toast.makeText(MemberMobileNumberToPay.this, "Please Enter Mobile Number", Toast.LENGTH_SHORT).show();
                } else {
...
//                                Toast.makeText(MemberRechargeActivity.this, "Number=" + num, Toast.LENGTH_LONG).show();
    ...
    private class getMemberNameFromMobileNumber extends AsyncTask<String, String, String> {
        ...
        protected void onPreExecute() {
            ...
            pd = new ProgressDialog(MemberMobileNumberToPay.this);
        ...
        protected void onPostExecute(String s) {
            ...
            try {
                ...
                if (strStutus.equalsIgnoreCase("1")) {
                    ...
                    Intent intent = new Intent(MemberMobileNumberToPay.this, MemberQRCodeResultActivity.class);
                    intent.putExtra("type", "mobile");
                    intent.putExtra("memberId", MemberHomeActivity.strMemberId);
                    intent.putExtra("memberName", strMemberName);
                    intent.putExtra("strMobileNumber", strSpiltMobileNumber);
                    startActivity(intent);
                } else {
                    Toast.makeText(MemberMobileNumberToPay.this, "Invalid Mobile Number", Toast.LENGTH_SHORT).show();
                }
