...
public class VendorRegistrationActivity extends AppCompatActivity {
    ...
    private TextView txtErrorMobileNumber;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        etVendorMobile.setOnFocusChangeListener(new View.OnFocusChangeListener() {
            @Override
            public void onFocusChange(View v, boolean hasFocus) {
                ...
                if (!hasFocus){
                    ...
                    Log.d(TAG, "onFocusChange mobile number: "+strMobileNumber);
...
//            Toast.makeText(VendorRegistrationActivity.this, "Please Enter Vendor Id", Toast.LENGTH_SHORT).show();
         ...
         if (StringUtils.isBlank(strVendorName)) {
            ...
            Toast.makeText(VendorRegistrationActivity.this, "Please Enter Email Id", Toast.LENGTH_SHORT).show();
             ...
             Toast.makeText(VendorRegistrationActivity.this, "InValid Mobile Number", Toast.LENGTH_SHORT).show();
