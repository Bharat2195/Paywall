...
/**
 * Created by bharat_android on 2/17/2017.
 */
...
public class SlidingImage_Adapter extends PagerAdapter {
    ...
    public SlidingImage_Adapter(Context context, ArrayList<String> IMAGES, ArrayList<String> VendorId) {
...
//        imageView.setImageResource(IMAGES.get(position));
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
                                    ...
                                    public void onClick(View v) {
                                        ...
                                        intent.putExtra("strImagePath", IMAGES.get(position));
                                        intent.putExtra("strId", VendorId.get(position));
